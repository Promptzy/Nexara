      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-blue-400 font-semibold text-lg">Join the Zenjira Revolution</span>
              </motion.div>
              ...
              <div className="space-y-4">
                ...
                >
                  Join thousands of teams already using AI-powered automation to supercharge their workflow and achieve unprecedented success
                </motion.p>
              </div>
            </motion.div>
          ...
          >
            ...
            <a href="/terms" className="text-blue-400 hover:text-blue-300 underline underline-offset-4 transition-colors">
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="/privacy" className="text-blue-400 hover:text-blue-300 underline underline-offset-4 transition-colors">
              Privacy Policy
            </a>
          </motion.div>
        </div>
