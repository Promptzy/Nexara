    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-purple-400 font-semibold text-lg">Welcome Back to Zenjira</span>
              </motion.div>
              ...
              <div className="space-y-4">
                ...
                >
                  Sign in to access your AI-powered project management workspace and unlock unlimited possibilities
                </motion.p>
              </div>
            </motion.div>
          ...
          >
            Need help?{" "}
            <a href="/support" className="text-purple-400 hover:text-purple-300 underline underline-offset-4 transition-colors">
              Contact Support
            </a>
          </motion.div>
        </div>
