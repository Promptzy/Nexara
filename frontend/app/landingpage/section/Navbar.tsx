            ...
            <div className="container mx-auto px-4">
                ...
                `}>
                    ...
                    <div className="flex items-center">
                        <Image src={logo} alt="Zenjira logo" className="h-8 lg:h-10 w-auto"/>
                    </div>
                    ...
                    <div className="flex justify-end items-center gap-2">
                        ...
                        <div className="hidden sm:flex items-center gap-2">
                            <Button variant="secondary" className="text-xs lg:text-sm px-3 lg:px-4 py-1.5 lg:py-2">
                                Login
                            </Button>
                            <Button variant="primary" className="text-xs lg:text-sm px-3 lg:px-4 py-1.5 lg:py-2">
                                Signup
                            </Button>
                        </div>
                    </div>
