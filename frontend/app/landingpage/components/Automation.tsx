...
export default function Automation() {
  ...
  const automationFeatures = [
    {
      ...
      description:
        'Drag-and-drop interface inspired by n8n for creating complex automation workflows without coding.',
    ...
    },
    {
      ...
      description:
        "Intelligent bots that learn from your team's patterns and suggest automation opportunities.",
    ...
    },
    {
      ...
      description:
        'Write custom JavaScript or Python code for advanced automation scenarios and integrations.',
    ...
    },
    {
      ...
      description:
        'Set up automated actions triggered by events like new tasks, deadlines, or team updates.',
    ...
    },
    {
      ...
      description:
        'AI-optimized scheduling that considers team capacity, priorities, and dependencies.',
    ...
    },
    {
      ...
      description:
        'Instant workflow execution with live monitoring and rollback capabilities.',
  ...
  const workflowSteps = [
    ...
    },
    {
      ...
      title: 'Add Actions',
      description:
        'Connect actions like notifications, task updates, or external API calls',
      icon: '⚡',
    },
    {
      step: '03',
  ...
  return (
    <section
      id="automation"
      className="py-20 bg-gradient-to-br from-slate-900 via-black to-slate-900 relative overflow-hidden"
    >
      {/* Animated Background */}
            ...
            >
              <Card className="h-full transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/25 hover:border-purple-500/50 bg-gradient-to-br from-slate-900/50 to-slate-800/50 border-slate-700/50 backdrop-blur-sm overflow-hidden">
                ...
                <CardHeader className="text-center pb-4 relative z-10">
                  ...
                  >
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${feature.color} rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-all duration-300`}
                    >
                      <motion.div
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto">
              Our intuitive interface makes it easy to create powerful
              automation workflows without any technical knowledge.
            </p>
          </div>
          ...
          <Card className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-purple-500/30 backdrop-blur-sm overflow-hidden relative">
            ...
            <CardContent className="p-8 relative z-10">
              ...
              <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
                Start building intelligent automation workflows today. No coding
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white shadow-lg shadow-purple-500/25 hover:shadow-xl hover:shadow-purple-500/30"
                  >
                ...
                >
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-purple-500/50 text-purple-300 hover:bg-purple-500/10 hover:border-purple-400"
                  >
                    View Templates
                  </Button>
                </motion.div>
