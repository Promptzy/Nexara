  ...
  const benefits = [
    {
      ...
      description:
        'No complex setup required. Start managing projects immediately.',
    },
    {
      icon: Shield,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            collaborate better, and deliver exceptional results. Start your free
            trial today and see the difference AI-powered project management can
            make.
          </motion.p>
          ...
          <Card className="bg-gradient-to-r from-slate-900/80 to-slate-800/80 border-slate-700/50 backdrop-blur-sm overflow-hidden relative">
            ...
            <CardContent className="p-8 relative z-10">
              ...
              <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
                Join companies like Microsoft, Google, and thousands of startups
                who trust Nexara with their project management needs.
              </p>
