  ...
  const features = [
    {
      ...
      description:
        'Customizable Kanban and Scrum boards with real-time collaboration and AI-powered task suggestions.',
    ...
    },
    {
      ...
      description:
        'Plan and execute agile sprints with intelligent backlog prioritization and milestone tracking.',
      category: 'Planning & Tracking',
    },
    {
      icon: BarChart3,
      ...
      description:
        'Get insights into team performance, project progress, and automated analytics dashboards.',
    ...
    },
    {
      ...
      description:
        'Secure project management with Admin, Moderator, and User roles for proper governance.',
    ...
    },
    {
      ...
      title: 'AI Automation',
      description:
        'Intelligent task automation, predictive analytics, and smart workflow optimization.',
    ...
    },
    {
      ...
      description:
        'Bank-level security with encryption, SSO, and compliance standards for enterprise teams.',
      category: 'Security & Collaboration',
    },
    {
      icon: GitBranch,
      ...
      description:
        'Seamless integration with GitHub, GitLab, and Bitbucket for code-to-task linking.',
    ...
    },
    {
      ...
      description:
        'Built-in chat, comments, and notifications to keep everyone in sync.',
      category: 'Security & Collaboration',
    },
    {
      icon: Workflow,
      ...
      description:
        'Drag-and-drop workflow builder inspired by n8n for complex automation scenarios.',
      category: 'AI & Automation',
    },
    {
      icon: Target,
      title: 'Goal Tracking',
      description:
        'Align tasks with company objectives and track progress with automated insights.',
      category: 'Planning & Tracking',
    },
    {
      icon: Clock,
      title: 'Time Tracking',
      description:
        'Built-in time tracking with AI-powered estimates and productivity analytics.',
      category: 'Reporting & Analytics',
    },
    {
      icon: TrendingUp,
      ...
      description:
        'Monitor team velocity, cycle time, and deployment frequency with actionable insights.',
      category: 'Reporting & Analytics',
    },
  ]
    ...
    <section id="features" className="py-20 bg-black relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-16">
          ...
          >
            Nexara combines the best of Jira with AI-powered automation, giving
            you a complete project management solution that scales with your
            team.
          </motion.p>
        </div>
          ...
          <Card className="bg-gradient-to-r from-cyan-500/10 to-emerald-500/10 border-cyan-500/30 backdrop-blur-sm overflow-hidden relative">
            ...
            <CardContent className="p-8 relative z-10">
              ...
              <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
                Join thousands of teams already using Nexara to ship faster,
                collaborate better, and deliver exceptional results.
              </p>
