...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-8 stagger-child" style={{ '--stagger-index': 1 } as React.CSSProperties}>
        ...
        <p className="text-xl text-neutral-300 mt-4 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          We build tools that free your development team from the noise — using intelligent automation, 
