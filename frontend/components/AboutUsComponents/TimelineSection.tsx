...
const TimelineSection: React.FC = () => {
  const timelineItems = [
    ...
    },
    {
      ...
      description: "Added no-code automation capabilities for complex workflows",
      status: "completed",
      icon: CheckCircle,
      delay: 0.2
    },
    ...
    },
    {
      ...
      description: "Enterprise-grade features with advanced security and compliance",
      status: "future",
      icon: Sparkles,
      delay: 0.4
    }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
            From inception to innovation - tracking our progress and what&apos;s coming next.
          </p>
        </div>
