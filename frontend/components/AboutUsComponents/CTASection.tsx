      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl text-neutral-300 leading-relaxed max-w-3xl mx-auto">
            Whether you&apos;re a developer, a product owner, or a curious innovator — Zenjira is built for you.
            <br />
            <span className="text-blue-400 font-medium">Let&apos;s simplify the future of software development. Together.</span>
          </p>
        </div>
