      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-300 max-w-3xl mx-auto">
            From AI-powered automation to advanced analytics, Zenjira provides
            comprehensive tools to transform your Jira experience and boost team
            productivity.
          </p>
        </div>
        ...
        <div className="mb-20">
          ...
          <p className="text-slate-400 text-center mb-12">
            Essential capabilities that power your daily workflow
          </p>
        ...
        <div>
          ...
          <p className="text-slate-400 text-center mb-12">
            Powerful tools for enhanced productivity and insights
          </p>
